...
- [ ] `(feat)` [programmatic-integrity-gates-and-git-guard](file://.along/ISSUES/feat--programmatic-integrity-gates-and-git-guard.md)
- [ ] `(feat)` [runtime-enforcement-of-prose-rules](file://.along/ISSUES/feat--runtime-enforcement-of-prose-rules.md)
- [ ] `(feat)` [systemic-anomaly-circuit-breaker](file://.along/ISSUES/feat--systemic-anomaly-circuit-breaker.md)
...
## Done (recent)
- [x] `(task)` [extend-sanitizer-scope-to-docs-and-root](file://.along/ISSUES/done/task--extend-sanitizer-scope-to-docs-and-root.md)
- [x] `(feat)` [well-known-llms-and-context-discovery](file://.along/ISSUES/done/feat--well-known-llms-and-context-discovery.md)
...
- [x] `(feat)` [kb-source-provenance-and-reconstruction](file://.along/ISSUES/done/feat--kb-source-provenance-and-reconstruction.md)
...
- [x] `(bug)` [recent-features-defects-and-guard-messages](file://.along/ISSUES/done/bug--recent-features-defects-and-guard-messages.md)
...
- [x] `(bug)` [installer-parity-and-destructive-rules-overwrite](file://.along/ISSUES/done/bug--installer-parity-and-destructive-rules-overwrite.md)
