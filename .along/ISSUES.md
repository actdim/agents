...
- [ ] `(bug)` [handrolled-yaml-loses-block-lists](file://.along/ISSUES/bug--handrolled-yaml-loses-block-lists.md)
...
- [ ] `(bug)` [subprocess-encoding-breaks-on-non-utf8-locale](file://.along/ISSUES/bug--subprocess-encoding-breaks-on-non-utf8-locale.md)
...
- [ ] `(debt)` [extract-shared-python-library](file://.along/ISSUES/debt--extract-shared-python-library.md)
