...
description: Query project Knowledge Base (docs/, README.md, DECISIONS.md) using targeted structured retrieval. Use when invoking /along-kb-search (aliases: /kb-search, /along-search-kb).
---
